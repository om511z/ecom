...
export const getShirt = () => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get('/api/v2/shirt')
...
export const getshirtDetails = (id) => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get(`/api/v2/shirt/${id}`)
...
export const getTshirt = () => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get('/api/v2/tshirt')
...
export const gettshirtDetails = (id) => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get(`/api/v2/tshirt/${id}`)
...
export const getJeans = () => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get('/api/v2/jeans')
...
export const getjeansDetails = (id) => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get(`/api/v2/jeans/${id}`)
...
export const getJacket = () => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get('/api/v2/jacket')
...
export const getjacketDetails = (id) => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get(`/api/v2/jacket/${id}`)
...
export const getKurta = () => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get('/api/v2/kurtas')
...
export const getkurtaDetails = (id) => async (dispatch) =>{
    try{
        ...
        const {data} = await axios.get(`/api/v2/kurtas/${id}`)
